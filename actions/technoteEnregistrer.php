...
{
	if ( ($_SESSION['technoteAjouter']  == 1 && $_POST['id_techquestion'] == "" ) || ($_SESSION['technoteModifier'] == 1 &&  $_POST['id_techquestion'] != ""  ) || ( $_POST['id_techquestion'] != "" &&  $_SESSION['technoteAjouter'] == 1 &&  $_SESSION['id_membre'] == $_POST['idAuteur'] ) )
	{
